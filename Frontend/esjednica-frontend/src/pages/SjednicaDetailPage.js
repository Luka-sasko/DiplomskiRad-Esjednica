      ...
      {isEditModalOpen && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <SjednicaForm
              sjednica={sjednicaStore.sjednica}
      ...
      <div className="tocke-sjednice-wrapper">
        <div className="sjednice-header" style={{ marginTop: "30px" }}>
          ...
          {isAdmin && (
            <button
              className="add-button"
              onClick={() => setIsAddTockaModalOpen(true)}
            >
              ➕ Dodaj točku
            </button>
          )}
          ...
          <table className="sjednica-table">
            ...
            <tbody>
              {sortedTocke.map((t) => (
                <tr
                  key={t.id}
                  onClick={() => navigate(`/sjednice/${id}/tocke/${t.id}`)}
